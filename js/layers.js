...
addLayer("at", {
	...
	milestones: {
		...
		2: {
			requirementDescription: "Auto-Enhancers & Auto-Extra Time Capsules",
			done() { return hasMilestone("q", 1) },
			toggles: [["e", "auto"], ["t", "autoExt"]],
			unlocked() { return player.q.unlocked },
		},
		3: {
			requirementDescription: "Auto-Time Capsules & Auto-Space Energy",
			done() { return hasMilestone("q", 3) },
			toggles: [["t", "auto"], ["s", "auto"]],
			unlocked() { return player.q.unlocked },
		},
		4: {
			requirementDescription: "Auto-Super Boosters",
			done() { return hasMilestone("q", 4) },
			toggles: [["sb", "auto"]],
			unlocked() { return player.q.unlocked },
		},
		5: {
		...
		7: {
			...
			done() { return hasMilestone("ba", 1) },
			toggles: [["q", "auto"]],
			unlocked() { return player.ba.unlocked },
		},
		8: {
			requirementDescription: "Auto-Subspace Energy",
			done() { return hasMilestone("ba", 2) },
			toggles: [["ss", "auto"]],
			unlocked() { return player.ba.unlocked },
		},
		9: {
			requirementDescription: "Auto-Spells",
			done() { return hasMilestone("hn", 2) },
			toggles: [["m", "auto"]],
			unlocked() { return player.hn.unlocked },
		},
		10: {
			requirementDescription: "Auto-Phantom Souls",
			done() { return hasMilestone("hn", 4) },
			toggles: [["ps", "auto"]],
			unlocked() { return player.hn.unlocked },
		},
		11: {
			requirementDescription: "Auto-Wraiths",
			done() { return hasMilestone("hn", 5) },
			toggles: [["ps", "autoW"]],
			unlocked() { return player.hn.unlocked },
		},
		12: {
			requirementDescription: "Auto-Ghost Spirit",
			done() { return hasMilestone("ma", 0) },
			toggles: [["ps", "autoGhost"]],
			unlocked() { return player.ma.unlocked },
		},
		13: {
			requirementDescription: "Auto-Imperium Bricks",
			done() { return hasMilestone("ma", 4) },
			toggles: [["i", "auto"]],
			unlocked() { return player.ma.unlocked },
		},
		14: {
			requirementDescription: "Auto-Hyperspace",
			done() { return hasMilestone("ma", 5) },
			toggles: [["hs", "auto"]],
			unlocked() { return player.ma.unlocked },
		},
	},
